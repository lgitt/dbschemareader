...
{
    /// <summary>
    /// Use static <see cref="FindTrigger"/> to find an Dm autoNumber trigger.
    /// </summary>
    public class DmSequenceTrigger
    {
        private DmSequenceTrigger(DatabaseTrigger databaseTrigger)
        {
        ...
        /// <returns></returns>
        public static DmSequenceTrigger FindTrigger(DatabaseTable databaseTable)
        {
            ...
            foreach (var databaseTrigger in databaseTable.Triggers)
            {
                ...
                var result = new DmSequenceTrigger(databaseTrigger);
