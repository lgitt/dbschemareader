...
{
    internal class ProcedureSources : DmSqlExecuter<ProcedureSource>
    {
...
ORDER BY OWNER, NAME, TYPE, LINE";
        ...
        protected override void Mapper(IDataRecord record)
        {
            ...
            switch (type)
            {
                case "PACKAGE": //Dm package
                    sourceType = SourceType.Package;
                    break;

                case "PACKAGE BODY": //Dm package body
                    sourceType = SourceType.PackageBody;
                    break;

                case "PROCEDURE": //Dm procedure
                    sourceType = SourceType.StoredProcedure;
                    break;

                case "FUNCTION": //Dm function
