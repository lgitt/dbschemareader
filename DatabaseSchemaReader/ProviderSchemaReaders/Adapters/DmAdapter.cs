...
using DatabaseSchemaReader.ProviderSchemaReaders.Databases.Dm;
...
{
    class DmAdapter : ReaderAdapter
    {
        public DmAdapter(SchemaParameters schemaParameters) : base(schemaParameters)
        {
        }
        ...
        private static void LookForAutoGeneratedId(DatabaseTable databaseTable)
        {
            ...
            var match = DmSequenceTrigger.FindTrigger(databaseTable);
